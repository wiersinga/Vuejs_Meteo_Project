<template>
  <header>
    <img alt="Vue logo" class="logo" src="https://cdn.freebiesupply.com/logos/large/2x/meteo-france-logo-svg-vector.svg" width="125" height="125" />
    ...
    <div class="wrapper">
      ...
      <nav>
        ...
        <RouterLink to="/CitiesList">Villes</RouterLink>
      </nav>
    </div>
  </header>
